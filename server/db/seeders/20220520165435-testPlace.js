  ...
  async up (queryInterface) {
    await queryInterface.bulkInsert('Places', [
      ...
      },
      {
        ...
        info: 'Можно полюбоваться видами, а еще это лучшее место для катания на вэйксёрфинге!!!',
        categoria: 'отдых',
...
// ============================================================================= Питер-Хельсинки
      ...
      //===================================================Москва-Элиста
      {
        ...
        categoria: 'еда',
        preset: 'islands#blueFoodIcon',
        adress: 'ул. Пушкина, 25А, Скопин',
        geometry: [53.824003, 39.554034],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        roadId: 5,
        title: 'Придорожное',
        info: 'Придорожное кафе',
        categoria: 'еда',
        preset: 'islands#blueFoodIcon',
        adress: 'Центральная ул., 79А, хутор Тары',
        geometry: [49.342618, 43.982752],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        roadId: 5,
        title: 'Лесная сказка',
        info: 'Деревянные домики и лес - что может быть лучше?',
        categoria: 'гостиница',
        preset: 'islands#blueHotelIcon',
        adress: 'Россия, Тамбовский район, Красносвободненский сельсовет, территория базы отдыха Лесная сказка, Дорожная улица, 7',
        geometry: [52.610265, 41.323817],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        categoria: 'заправки',
        preset: 'islands#blueFuelStationIcon',
        adress: 'Рязанская обл., Александро-Невский район, 330 км а/д "Москва-Волгоград"',
        geometry: [53.418680, 40.140014],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        categoria: 'заправки',
        preset: 'islands#blueFuelStationIcon',
        adress: 'Рубежная ул., 13, Михайловка',
        geometry: [50.003962, 43.201079],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        categoria: 'аптека',
        preset: 'islands#blueMedicalIcon',
        adress: 'ул. Ленина, 81, Новоаннинский',
        geometry: [50.527394, 42.666589],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        roadId: 5,
        title: 'Шоколадушка',
        info: 'Кондитерскаямузей',
        categoria: 'отдых',
        preset: 'islands#blueStarIcon',
        adress: 'ул. Рокоссовского, 28, Волгоград',
        geometry: [61.824966, 34.512576],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      //===================================================Москва-Элиста
      {
        roadId: 6,
        title: 'Стардогс',
        info: 'Быстрое питание',
        categoria: 'еда',
        preset: 'islands#blueFoodIcon',
        adress: '11, Нелидово, АЗК № 21',
        geometry: [56.262809, 32.839375],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        categoria: 'заправки',
        preset: 'islands#blueFuelStationIcon',
        adress: 'Россия, Тверская область, Зубцовский район, М-9 Балтия, 188-й километр',
        geometry: [56.151476, 34.901392],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        roadId: 6,
        title: 'Сургутнефтегаз Псковнефтепродукт',
        info: 'АЗСАГНС, АГЗС, АГНКС',
        categoria: 'заправки',
        preset: 'islands#blueFuelStationIcon',
        adress: 'Заречная ул., с34, Пустошка МАЗС № 13, трасса Санкт-Петербург - Киев',
        geometry: [56.310581, 29.386255],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        categoria: 'аптека',
        preset: 'islands#blueMedicalIcon',
        adress: 'ул. Победы, 36, стр. 1, Зубцов',
        geometry: [56.174848, 34.571115],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        roadId: 6,
        title: 'Пушкинская деревня',
        info: 'Скопление большого количества музеев',
        categoria: 'отдых',
        preset: 'islands#blueStarIcon',
        adress: 'Россия, Псковская область, Пушкиногорский район, деревня Бугрово',
        geometry: [57.046663, 28.917933],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        roadId: 6,
        title: 'Радуга',
        info: 'Придорожная гостиница',
        categoria: 'гостиница',
        preset: 'islands#blueHotelIcon',
        adress: 'Россия, Псковская область, Куньинский район, М-9 Балтия, 438-й километр',
        geometry: [56.276216, 30.968286],
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
